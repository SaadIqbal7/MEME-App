...
import com.example.meme.container.MemeTemplate;
...
public class MemeTemplateAdapter extends RecyclerView.Adapter<MemeTemplateAdapter.MemeTemplateViewHolder> {
	...
	public MemeTemplateAdapter(Context context, ArrayList<MemeTemplate> templates, RecycleViewerClickListener recycleViewerClickListener) {
