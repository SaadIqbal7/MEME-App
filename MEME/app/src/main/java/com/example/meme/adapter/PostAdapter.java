...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.PostViewHolder> {
	...
	public PostAdapter(Context context, ArrayList<Post> posts, OnBottomReachedListener onBottomReachedListener, PostRecyclerViewOnClickListeners postRecyclerViewOnClickListeners) {
